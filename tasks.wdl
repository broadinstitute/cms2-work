...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-origin-broad/master--4ff3efbc814aa9deb0a94a4715aa992670ee4d60/structs.wdl"
...
task old_compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/origin-broad/master/4ff3efbc814aa9deb0a94a4715aa992670ee4d60/old_remodel_components.py"
    String docker
    Int preemptible
...
task compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/origin-broad/master/4ff3efbc814aa9deb0a94a4715aa992670ee4d60/remodel_components.py"
    String docker
    Int preemptible
    ComputeResources compute_resources
  }
...
task normalize_and_collate_block {
  ...
  File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/origin-broad/master/4ff3efbc814aa9deb0a94a4715aa992670ee4d60/norm_and_collate_block.py"
  #String replica_id_str = basename(inp.ihs_out, ".ihs.out")
  #String normed_collated_stats_fname = replica_id_str + ".normed_and_collated.tsv"
  command <<<
...
task collate_stats_and_metadata_for_all_sel_sims {
  ...
  input {
    ...
    File collate_stats_and_metadata_for_all_sel_sims_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/origin-broad/master/4ff3efbc814aa9deb0a94a4715aa992670ee4d60/collate_stats_and_metadata_for_all_sel_sims.py"
  }
  command <<<
