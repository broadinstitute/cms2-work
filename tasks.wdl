...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210822-2127-add-pop-pair-match-checks--ba1985fd136becde9415dd2c49cd0c8edc43a98d/structs.wdl"
...
task compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/ba1985fd136becde9415dd2c49cd0c8edc43a98d/remodel_components.py"
    String docker
    Int preemptible
...
task normalize_and_collate_block {
  ...
  File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/ba1985fd136becde9415dd2c49cd0c8edc43a98d/norm_and_collate_block.py"
...
task collate_stats_and_metadata_for_sel_sims_block {
  ...
  input {
    ...
    File collate_stats_and_metadata_for_sel_sims_block_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/ba1985fd136becde9415dd2c49cd0c8edc43a98d/collate_stats_and_metadata_for_sel_sims_block.py"
  }
...
# ** outputs
  ...
  File construct_pops_info_for_1KG_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/ba1985fd136becde9415dd2c49cd0c8edc43a98d/construct_pops_info_for_1KG.py"
...
# ** outputs
  ...
  input {
    ...
    File fetch_empirical_regions_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/ba1985fd136becde9415dd2c49cd0c8edc43a98d/fetch_empirical_regions.py"
  }
  command <<<
    set -ex -o pipefail
