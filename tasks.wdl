...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210604-1534-add-checkpointing--0de1ea071302ac10bec593844e9319a7deb0202c/structs.wdl"
...
task compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210604-1534-add-checkpointing/0de1ea071302ac10bec593844e9319a7deb0202c/remodel_components.py"
    String docker
    Int preemptible
...
task normalize_and_collate_block {
  ...
  File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210604-1534-add-checkpointing/0de1ea071302ac10bec593844e9319a7deb0202c/norm_and_collate_block.py"
  #String replica_id_str = basename(inp.ihs_out, ".ihs.out")
  #String normed_collated_stats_fname = replica_id_str + ".normed_and_collated.tsv"
  command <<<
...
task collate_stats_and_metadata_for_all_sel_sims {
  ...
  input {
    ...
    File collate_stats_and_metadata_for_all_sel_sims_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210604-1534-add-checkpointing/0de1ea071302ac10bec593844e9319a7deb0202c/collate_stats_and_metadata_for_all_sel_sims.py"
  }
  ...
  runtime {
    ...
    memory: "16 GB"
    cpu: 1
    disks: "local-disk ${disk_size_capped_gb} HDD"
  }
}
