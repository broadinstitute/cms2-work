...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210430-1631-pick-stats-to-compute--e9831d347703bf0621f1c11c0d8f966868978244/structs.wdl"
...
task old_compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210430-1631-pick-stats-to-compute/e9831d347703bf0621f1c11c0d8f966868978244/old_remodel_components.py"
    String docker
    Int preemptible
...
task compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210430-1631-pick-stats-to-compute/e9831d347703bf0621f1c11c0d8f966868978244/remodel_components.py"
    String docker
    Int preemptible
    ComputeResources compute_resources
  }
...
task collate_stats_and_metadata_for_all_sel_sims {
  ...
  input {
    ...
    File collate_stats_and_metadata_for_all_sel_sims_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210430-1631-pick-stats-to-compute/e9831d347703bf0621f1c11c0d8f966868978244/collate_stats_and_metadata_for_all_sel_sims.py"
  }
  command <<<
