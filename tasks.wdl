...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210430-1631-pick-stats-to-compute--981419b9916770a922d1d79ed4c3542c365f4d5d/structs.wdl"
...
task old_compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210430-1631-pick-stats-to-compute/981419b9916770a922d1d79ed4c3542c365f4d5d/old_remodel_components.py"
    String docker
    Int preemptible
...
task compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210430-1631-pick-stats-to-compute/981419b9916770a922d1d79ed4c3542c365f4d5d/remodel_components.py"
    String docker
    Int preemptible
    ComputeResources compute_resources
  }
...
task collate_stats_and_metadata_for_all_sel_sims {
  ...
  input {
    ...
    File collate_stats_and_metadata_for_all_sel_sims_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210430-1631-pick-stats-to-compute/981419b9916770a922d1d79ed4c3542c365f4d5d/collate_stats_and_metadata_for_all_sel_sims.py"
  }
  command <<<
