...
task compute_one_pop_cms2_components {
  ...
  runtime {
    ...
    memory: select_first([compute_resources.mem_gb, 1]) + " GB"
    cpu: select_first([compute_resources.cpus, 1])
    disks: "local-disk " + select_first([compute_resources.local_storage_gb, 10]) + " HDD"
  }
}
...
task collate_stats_and_metadata_for_all_sel_sims {
  ...
  input {
    ...
    File collate_stats_and_metadata_for_all_sel_sims_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210506-1732-collate-neutral-sims/295666c50e678ac81f0782d23a82556a2682228f/collate_stats_and_metadata_for_all_sel_sims.py"
  }
  command <<<
