...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210614-1134-add-empirical-data-processing--9332eb702a896b020159c793e7c8359116762004/structs.wdl"
...
task compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210614-1134-add-empirical-data-processing/9332eb702a896b020159c793e7c8359116762004/remodel_components.py"
    String docker
    Int preemptible
...
task normalize_and_collate_block {
  ...
  File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210614-1134-add-empirical-data-processing/9332eb702a896b020159c793e7c8359116762004/norm_and_collate_block.py"
  #String replica_id_str = basename(inp.ihs_out, ".ihs.out")
  #String normed_collated_stats_fname = replica_id_str + ".normed_and_collated.tsv"
  command <<<
...
task collate_stats_and_metadata_for_sel_sims_block {
  ...
  input {
    ...
    File collate_stats_and_metadata_for_sel_sims_block_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210614-1134-add-empirical-data-processing/9332eb702a896b020159c793e7c8359116762004/collate_stats_and_metadata_for_sel_sims_block.py"
  }
...
# ** outputs
  ...
  input {
    ...
    File fetch_empirical_regions_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210614-1134-add-empirical-data-processing/9332eb702a896b020159c793e7c8359116762004/fetch_empirical_regions.py"
  }
  command <<<
    mkdir "${PWD}/hapsets"
