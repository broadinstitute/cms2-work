...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210604-1534-add-checkpointing--b0b83cf499a3eb0ac97efa9e9ba9b40915493ff8/structs.wdl"
...
task compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210604-1534-add-checkpointing/b0b83cf499a3eb0ac97efa9e9ba9b40915493ff8/remodel_components.py"
    String docker
    Int preemptible
...
task normalize_and_collate_block {
  ...
  File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210604-1534-add-checkpointing/b0b83cf499a3eb0ac97efa9e9ba9b40915493ff8/norm_and_collate_block.py"
  #String replica_id_str = basename(inp.ihs_out, ".ihs.out")
  #String normed_collated_stats_fname = replica_id_str + ".normed_and_collated.tsv"
  command <<<
...
task collate_stats_and_metadata_for_sel_sims_block {
  ...
  input {
    ...
    File collate_stats_and_metadata_for_sel_sims_block_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210604-1534-add-checkpointing/b0b83cf499a3eb0ac97efa9e9ba9b40915493ff8/collate_stats_and_metadata_for_sel_sims_block.py"
  }
