...
task compute_one_pop_cms2_components {
  ...
  File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-211013-1315-add-isafe/318e9138b388cbb8bf690190993b77eb0ae07198/compute_cms2_components.py"
...
task normalize_and_collate_block {
  ...
  File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-211013-1315-add-isafe/318e9138b388cbb8bf690190993b77eb0ae07198/norm_and_collate_block.py"
  command <<<
    set -ex -o pipefail
...
task collate_stats_and_metadata_for_sel_sims_block {
  ...
  File collate_stats_and_metadata_for_sel_sims_block_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-211013-1315-add-isafe/318e9138b388cbb8bf690190993b77eb0ae07198/collate_stats_and_metadata_for_sel_sims_block.py"
...
# ** outputs
  ...
  File construct_pops_info_for_1KG_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-211013-1315-add-isafe/318e9138b388cbb8bf690190993b77eb0ae07198/construct_pops_info_for_1KG.py"
...
# ** outputs
  ...
  File fetch_empirical_hapsets_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-211013-1315-add-isafe/318e9138b388cbb8bf690190993b77eb0ae07198/fetch_empirical_hapsets.py"
...
# ** outputs
  ...
  File fetch_neutral_regions_nre_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-211013-1315-add-isafe/318e9138b388cbb8bf690190993b77eb0ae07198/fetch_neutral_regions_nre.py"
  ...
  runtime {
    docker: "quay.io/ilya_broad/cms:webdriver-webdriver-6dba18313775d137217c8a45c4bdd53d6b4e4441"
    memory: "4 GB"
    cpu: 1
...
task fetch_file_from_url {
  ...
  runtime {
    docker: "quay.io/ilya_broad/cms:common-tools-common-tools-67c27fe434bbc6bc48272f6121d905a2ef0ca258"
    memory: "4 GB"
    cpu: 1
    disks: "local-disk 32 HDD"
    preemptible: 1
