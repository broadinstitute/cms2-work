...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210407-1304-add-sim-info-to-collate.org--53c4db94cbf2eabd3cf508bf8babcfde08abe903/structs.wdl"
...
task collate_stats_and_metadata_for_all_sel_sims {
  ...
  input {
    ...
    File collate_stats_and_metadata_for_all_sel_sims_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210407-1304-add-sim-info-to-collate.org/53c4db94cbf2eabd3cf508bf8babcfde08abe903/collate_stats_and_metadata_for_all_sel_sims.py"
  }
  command <<<
    python3 "~{collate_stats_and_metadata_for_all_sel_sims_script}" --input-json "~{write_json(inp)}" 
  >>>
  output {
    File all_hapsets_compstats_tsv_gz = inp.experimentId + ".compstats.tsv.gz"
    File all_hapsets_metadata_tsv_gz = inp.experimentId + ".metadata.tsv.gz"
  }
  runtime {
    docker: "quay.io/ilya_broad/cms@sha256:a02b540e5d5265a917d55ed80796893b448757a7cacb8b6e30212400e349489a"  # selscan=1.3.0a09
    memory: "16 GB"
