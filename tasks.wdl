...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210602-1447-compstats-in-blocks--47c9ff9d2ad2d18911da16add01ecb1d4e8ed7f5/structs.wdl"
...
task old_compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210602-1447-compstats-in-blocks/47c9ff9d2ad2d18911da16add01ecb1d4e8ed7f5/old_remodel_components.py"
    String docker
    Int preemptible
...
task compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210602-1447-compstats-in-blocks/47c9ff9d2ad2d18911da16add01ecb1d4e8ed7f5/remodel_components.py"
    String docker
    Int preemptible
    ComputeResources compute_resources
  }
...
task normalize_and_collate_block {
  ...
  File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210602-1447-compstats-in-blocks/47c9ff9d2ad2d18911da16add01ecb1d4e8ed7f5/norm_and_collate_block.py"
  #String replica_id_str = basename(inp.ihs_out, ".ihs.out")
  #String normed_collated_stats_fname = replica_id_str + ".normed_and_collated.tsv"
  command <<<
...
task collate_stats_and_metadata_for_all_sel_sims {
  ...
  input {
    ...
    File collate_stats_and_metadata_for_all_sel_sims_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210602-1447-compstats-in-blocks/47c9ff9d2ad2d18911da16add01ecb1d4e8ed7f5/collate_stats_and_metadata_for_all_sel_sims.py"
  }
  command <<<
