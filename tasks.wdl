...
task compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/f2e5c65b640d6814bae3acf748fd1640920571c9/remodel_components.py"
    String docker
    Int preemptible
...
task normalize_and_collate_block {
  ...
  File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/f2e5c65b640d6814bae3acf748fd1640920571c9/norm_and_collate_block.py"
...
task collate_stats_and_metadata_for_sel_sims_block {
  ...
  input {
    ...
    File collate_stats_and_metadata_for_sel_sims_block_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/f2e5c65b640d6814bae3acf748fd1640920571c9/collate_stats_and_metadata_for_sel_sims_block.py"
  }
...
# ** outputs
  ...
  File construct_pops_info_for_1KG_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/f2e5c65b640d6814bae3acf748fd1640920571c9/construct_pops_info_for_1KG.py"
...
# ** outputs
  ...
  File fetch_empirical_regions_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/f2e5c65b640d6814bae3acf748fd1640920571c9/fetch_empirical_regions.py"
