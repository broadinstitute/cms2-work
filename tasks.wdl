...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210430-1631-pick-stats-to-compute--ebe2b62a3b275c052f464d67fc5daaa8db94f41f/structs.wdl"
...
task old_compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210430-1631-pick-stats-to-compute/ebe2b62a3b275c052f464d67fc5daaa8db94f41f/old_remodel_components.py"
    String docker
    Int preemptible
...
task compute_one_pop_cms2_components {
  ...
  input {
    ...
    File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210430-1631-pick-stats-to-compute/ebe2b62a3b275c052f464d67fc5daaa8db94f41f/remodel_components.py"
    String docker
    Int preemptible
    ComputeResources compute_resources
  }
...
task collate_stats_and_metadata_for_all_sel_sims {
  ...
  input {
    ...
    File collate_stats_and_metadata_for_all_sel_sims_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/dockstore-tool-cms2/is-210430-1631-pick-stats-to-compute/ebe2b62a3b275c052f464d67fc5daaa8db94f41f/collate_stats_and_metadata_for_all_sel_sims.py"
  }
  command <<<
