...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210614-1134-add-empirical-data-processing--f8e6f736a22decabff9745efb5df627c012c7fd2/run_sims.wdl"
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210614-1134-add-empirical-data-processing--f8e6f736a22decabff9745efb5df627c012c7fd2/tasks.wdl"
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210614-1134-add-empirical-data-processing--f8e6f736a22decabff9745efb5df627c012c7fd2/compute_normalization_stats.wdl"
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210614-1134-add-empirical-data-processing--f8e6f736a22decabff9745efb5df627c012c7fd2/component_stats_for_sel_sims.wdl"
...
# ** inputs
  input {
    ...
    Int preemptible = 3
    File taskScript_simulation = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210614-1134-add-empirical-data-processing/f8e6f736a22decabff9745efb5df627c012c7fd2/runcosi.py"
    ...
    File compute_components_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210614-1134-add-empirical-data-processing/f8e6f736a22decabff9745efb5df627c012c7fd2/remodel_components.py"
    ...
    File get_pops_info_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210614-1134-add-empirical-data-processing/f8e6f736a22decabff9745efb5df627c012c7fd2/get_pops_info.py"
    File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210614-1134-add-empirical-data-processing/f8e6f736a22decabff9745efb5df627c012c7fd2/norm_and_collate.py"
