...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210822-2127-add-pop-pair-match-checks--ba1985fd136becde9415dd2c49cd0c8edc43a98d/run_sims.wdl"
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210822-2127-add-pop-pair-match-checks--ba1985fd136becde9415dd2c49cd0c8edc43a98d/tasks.wdl"
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210822-2127-add-pop-pair-match-checks--ba1985fd136becde9415dd2c49cd0c8edc43a98d/compute_normalization_stats.wdl"
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210822-2127-add-pop-pair-match-checks--ba1985fd136becde9415dd2c49cd0c8edc43a98d/component_stats_for_sel_sims.wdl"
...
# ** inputs
  input {
    ...
    Int preemptible = 3
    File taskScript_simulation = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/ba1985fd136becde9415dd2c49cd0c8edc43a98d/runcosi.py"
    ...
    File compute_components_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/ba1985fd136becde9415dd2c49cd0c8edc43a98d/remodel_components.py"
    ...
    File get_pops_info_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/ba1985fd136becde9415dd2c49cd0c8edc43a98d/get_pops_info.py"
    File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/ba1985fd136becde9415dd2c49cd0c8edc43a98d/norm_and_collate.py"
