...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210822-2127-add-pop-pair-match-checks--d54f373a882ffcb8166604d6b48253517741b32c/run_sims.wdl"
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210822-2127-add-pop-pair-match-checks--d54f373a882ffcb8166604d6b48253517741b32c/tasks.wdl"
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210822-2127-add-pop-pair-match-checks--d54f373a882ffcb8166604d6b48253517741b32c/compute_normalization_stats.wdl"
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210822-2127-add-pop-pair-match-checks--d54f373a882ffcb8166604d6b48253517741b32c/component_stats_for_sel_sims.wdl"
...
# ** inputs
  input {
    ...
    Int preemptible = 3
    File taskScript_simulation = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/d54f373a882ffcb8166604d6b48253517741b32c/runcosi.py"
    ...
    File compute_components_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/d54f373a882ffcb8166604d6b48253517741b32c/remodel_components.py"
    ...
    File get_pops_info_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/d54f373a882ffcb8166604d6b48253517741b32c/get_pops_info.py"
    File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/d54f373a882ffcb8166604d6b48253517741b32c/norm_and_collate.py"
