...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210822-2127-add-pop-pair-match-checks--e4008e3f5fac825788832f4efbb27fc14c384f9b/run_sims.wdl"
...
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210822-2127-add-pop-pair-match-checks--e4008e3f5fac825788832f4efbb27fc14c384f9b/compute_normalization_stats.wdl"
import "https://raw.githubusercontent.com/notestaff/cms2-staging/staging-is-210822-2127-add-pop-pair-match-checks--e4008e3f5fac825788832f4efbb27fc14c384f9b/component_stats_for_sel_sims.wdl"
...
# ** inputs
  input {
    ...
    Int preemptible = 3
    File taskScript_simulation = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/e4008e3f5fac825788832f4efbb27fc14c384f9b/runcosi.py"
    ...
    File compute_components_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/e4008e3f5fac825788832f4efbb27fc14c384f9b/remodel_components.py"
    ...
    File get_pops_info_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/e4008e3f5fac825788832f4efbb27fc14c384f9b/get_pops_info.py"
    File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-210822-2127-add-pop-pair-match-checks/e4008e3f5fac825788832f4efbb27fc14c384f9b/norm_and_collate.py"
